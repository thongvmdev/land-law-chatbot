...
- **Tra cứu lai (Hybrid Search - Semantic & Keyword):**
  - **Semantic Search (Vector):** Hiểu ý định câu hỏi tự nhiên (VD: _"Nhà nước lấy đất thì đền bù thế nào?"_ → tìm về "Bồi thường").
...
- **Kiểm chứng minh bạch (Click-to-Source):**
  ...
  - Khi click vào: Mở PDF gốc dạng Pop-up → Cuộn đến đúng trang → **Highlight** đoạn văn bản tham chiếu.
...
### Sprint 1: Foundation & Design (Phase 0)
**Duration:** 2 weeks  
**Status:** Future  
**Tasks:** 0.1

### Sprint 2: Data Engineering (Phase 1)
**Duration:** 3 weeks  
**Status:** Future  
**Tasks:** 1.1, 1.2, 1.3

### Sprint 3: Vector Database Setup (Phase 2)
**Duration:** 2 weeks  
**Status:** Future  
**Tasks:** 2.1, 2.2, 2.3

### Sprint 4: Agent Architecture (Phase 3)
**Duration:** 3 weeks  
**Status:** Future  
**Tasks:** 3.1, 3.2, 3.3, 3.4

### Sprint 5: Retrieval System (Phase 4)
**Duration:** 2 weeks  
**Status:** Future  
**Tasks:** 4.1, 4.2, 4.3

### Sprint 6: Generation & Frontend (Phases 5-6)
**Duration:** 4 weeks  
**Status:** Future  
**Tasks:** 5.1, 5.2, 5.3, 6.1, 6.2, 6.3

### Sprint 7: Testing & Refinement (Phase 7)
**Duration:** 2 weeks  
**Status:** Future  
**Tasks:** 7.1, 7.2
...
- [ ] **1.2. Structural Chunking (Cha-Con):**
  ...
  - Điều quá dài → cắt xuống **"Khoản"** (kèm Tiêu đề Điều).
...
- [ ] **3.3. Thiết kế Edges:** Logic rẽ nhánh (Nếu Grade = Fail → Rewrite).
...
- [ ] **6.3. PDF Viewer Pop-up:**
  - Tích hợp `react-pdf`.
  - Xử lý sự kiện Click → Mở Modal → Jump to Page.
...
1. **Create Project Page in Notion:**
   - Go to "Personal Project" page
   - Create a new page titled "Vietnam Land Law AI Agent 🇻🇳 ⚖️"
   - Copy the content from this file

2. **Create Sprints:**
   - Open "Vietnam Land Law AI Agent - Sprints" database
   - Create 7 sprints with the names and dates from section 3

3. **Create Tasks:**
   - Open "Vietnam Land Law AI Agent - Tasks" database
   - Create tasks for each item in section 4
   - Link each task to the appropriate Sprint
   - Set Phase, Priority, and Status fields

4. **Link Databases:**
   - Add the Tasks and Sprints databases to the project page for easy access
